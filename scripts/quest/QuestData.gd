...
const _TOWN_HALL_TUTORIAL := [
	{
		"type": "mcq",
		"instruction":
		"When a word ends with a silent 'e', the vowel before it says its own name. This is the silent-e rule. For example: 'can' becomes 'cane', and 'pin' becomes 'pine'.",
		"question": "Which word follows the silent-e rule?",
		"options": ["cake", "back", "black", "rack"],
		"correct_index": 0,
		"feedback_correct": "Yes! 'Cake' ends with a silent 'e', so the 'a' says its own name.",
		"feedback_wrong":
		"'Cake' is the silent-e word. The 'e' at the end makes the 'a' say its own name.",
	},
]
...
const _TOWN_HALL_PRACTICE := [
	{
		"type": "mcq",
		"instruction": "Words that end in the same sound belong to the same word family.",
		"question": "Which word belongs in the same word family as 'gate'?",
		"options": ["late", "got", "let", "fit"],
		"correct_index": 0,
		"hint": "Say each word. Which one ends with the same sound as 'gate'?",
		"feedback_correct": "'Late' and 'gate' are in the same word family — they end with the same sound!",
		"feedback_wrong": "'Gate' ends in the 'ate' sound. Look for the word that ends the same way.",
	},
	{
		"type": "mcq",
		"instruction": "Words that rhyme end with the same sound.",
		"question": "Which word rhymes with 'sit'?",
		"options": ["hit", "set", "sat", "sot"],
		"correct_index": 0,
		"hint": "Say 'sit' and then each choice. Which ends the same way?",
		"feedback_correct": "'Hit' and 'sit' rhyme — they both end with the same sound!",
		"feedback_wrong": "'Sit' ends with the 'it' sound. The word 'hit' ends the same way.",
	},
	{
		"type": "tap_target",
...
const _TOWN_HALL_MISSION := [
	# Part 1 — Vowel MCQ (4 items)
	{
		...
		"question": "Which word belongs in the same word family as 'fade'?",
		"options": ["made", "fed", "mud", "fin"],
		"correct_index": 0,
		"feedback_correct": "'Made' and 'fade' are in the same word family — same ending sound!",
		"feedback_wrong": "'Fade' ends in the 'ade' sound. The word 'made' ends the same way.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound.",
		"question": "Which word rhymes with 'pet'?",
		"options": ["set", "pat", "pit", "pot"],
		"correct_index": 0,
		"feedback_correct": "'Set' rhymes with 'pet' — they both end with the same sound!",
		"feedback_wrong": "'Pet' ends in the 'et' sound. The word 'set' ends the same way.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound.",
		"question": "Which word has the same middle sound as 'ride'?",
		"options": ["side", "rid", "red", "rod"],
		"correct_index": 0,
		"feedback_correct": "'Side' has the same middle sound as 'ride' — they both end with the 'ide' sound!",
		"feedback_wrong": "'Ride' and 'side' share the same middle vowel. They both end with the 'ide' sound.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound.",
		"question": "Which word has a DIFFERENT vowel sound from 'hop'?",
		"options": ["hope", "mop", "top", "drop"],
		"correct_index": 0,
		"feedback_correct": "'Hope' sounds different from 'hop' — the silent 'e' at the end changes the vowel!",
		"feedback_wrong": "'Hope' has a silent 'e' that changes its vowel sound, unlike 'hop', 'mop', 'top', and 'drop'.",
	},
...
const _TOWN_HALL_TUTORIAL_L2 := [
	{
		"type": "mcq",
		"instruction":
		"Words in the same word family share the same ending sounds. For example: cat, bat, hat, and mat all end in 'at'. Knowing word families helps you read new words faster!",
		"question": "Which word belongs in the 'at' word family with 'cat'?",
		"options": ["bat", "bet", "bit", "but"],
		"correct_index": 0,
		"feedback_correct": "Yes! 'Bat' ends in 'at', just like 'cat'. They are in the same word family!",
		"feedback_wrong":
		"The 'at' word family includes cat, bat, hat, and rat. They all end with 'at'. The answer is 'bat'!",
	},
]
...
const _TOWN_HALL_PRACTICE_L2 := [
	{
		...
		"options": ["red", "bad", "bid", "bud"],
		"correct_index": 0,
		"hint": "Say 'bed' slowly. Find the word that ends with the same sound.",
		"feedback_correct": "'Red' rhymes with 'bed' — they both end with the same sound!",
		"feedback_wrong": "'Bed' ends in the 'ed' sound. The word 'red' ends the same way.",
	},
	{
		"type": "mcq",
		"instruction": "Find the word that belongs in the same family.",
		"question": "Which word belongs in the 'ig' word family with 'pig'?",
		"options": ["big", "bag", "bug", "bog"],
		"correct_index": 0,
		"hint": "Look for the word that ends in 'ig', just like 'pig'.",
		"feedback_correct": "'Big' is in the 'ig' word family, just like 'pig'!",
		"feedback_wrong": "'Pig' ends in 'ig'. The word 'big' also ends in 'ig' — they are in the same family!",
	},
	{
		"type": "tap_target",
		"instruction": "Tap the consonant blend at the beginning of the word.",
...
const _TOWN_HALL_MISSION_L2 := [
	...
	{
		"type": "mcq",
		"instruction": "Identify the word family.",
		"question": "Which word belongs in the 'at' word family?",
		"options": ["hat", "hit", "hot", "hut"],
		"correct_index": 0,
		"feedback_correct": "'Hat' is in the 'at' word family, just like 'cat' and 'bat'!",
		"feedback_wrong": "The answer is 'hat' — it ends in 'at', which is the correct word family.",
	},
	{
		"type": "mcq",
		"instruction": "Find the rhyming word.",
		"question": "Which word rhymes with 'bed'?",
		"options": ["red", "rod", "rid", "rug"],
		"correct_index": 0,
		"feedback_correct": "'Red' and 'bed' rhyme — they both end with the same sound!",
		"feedback_wrong": "'Bed' ends in the 'ed' sound. The word 'red' ends the same way.",
	},
	{
		"type": "mcq",
		"instruction": "Find the word in the same family.",
		"question": "Which word is in the 'ig' word family with 'pig'?",
		"options": ["dig", "dog", "dug", "dag"],
		"correct_index": 0,
		"feedback_correct": "'Dig' is in the 'ig' word family, just like 'pig'!",
		"feedback_wrong": "'Pig' ends in 'ig'. The word 'dig' also ends in 'ig'.",
	},
	{
		"type": "mcq",
		"instruction": "Find the word in the same family.",
		"question": "Which word belongs in the 'op' word family with 'hop'?",
		"options": ["top", "tap", "tip", "tup"],
		"correct_index": 0,
		"feedback_correct": "'Top' is in the 'op' word family, just like 'hop'!",
		"feedback_wrong": "'Hop' ends in 'op'. The word 'top' also ends in 'op'.",
	},
...
const _TOWN_HALL_TUTORIAL_L3 := [
	{
		"type": "mcq",
		"instruction":
		"The silent-e rule changes a short vowel into a long one. Adding a silent 'e' at the end of a word makes the vowel say its own name. For example: 'pin' becomes 'pine', 'hop' becomes 'hope', and 'cut' becomes 'cute'. This rule helps you decode hundreds of new words!",
		"question": "Which word follows the silent-e rule?",
		"options": ["shine", "shin", "ship", "shift"],
		"correct_index": 0,
		"feedback_correct": "Right! 'Shine' follows the silent-e rule. The silent 'e' at the end makes the 'i' say its name.",
		"feedback_wrong":
		"'Shine' is the answer. It comes from 'shin' with a silent 'e' added at the end, so the 'i' says its name.",
	},
	{
		"type": "tap_target",
		"instruction":
...
const _TOWN_HALL_PRACTICE_L3 := [
	...
	{
		"type": "mcq",
		"instruction": "Use what you know about vowel patterns to decode unfamiliar words.",
		"question": "Which word has the same vowel sound as 'ship'?",
		"options": ["chip", "shape", "sheep", "shop"],
		"correct_index": 0,
		"hint": "Say each word. Which one has the same quick vowel sound in the middle as 'ship'?",
		"feedback_correct": "'Chip' has the same vowel sound as 'ship' — both have a quick 'i' in the middle.",
		"feedback_wrong": "'Ship' and 'chip' both have the same quick 'i' sound in the middle.",
	},
	{
		"type": "tap_target",
...
const _TOWN_HALL_MISSION_L3 := [
	# Part 1 — Vowel Sound MCQ (4 items)
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound.",
		"question": "Which word rhymes with 'take'?",
		"options": ["lake", "lack", "lick", "lock"],
		"correct_index": 0,
		"feedback_correct": "'Lake' rhymes with 'take' — they both end with the same sound!",
		"feedback_wrong": "'Take' ends in the 'ake' sound. The word 'lake' ends the same way.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound.",
		"question": "Which word has the same vowel sound as 'pen'?",
		"options": ["ten", "teen", "tan", "ton"],
		"correct_index": 0,
		"feedback_correct": "'Ten' has the same vowel sound as 'pen' — both have a quick 'e' in the middle.",
		"feedback_wrong": "'Pen' and 'ten' both have the same quick 'e' sound in the middle.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound.",
		"question": "Which word uses the same silent-e pattern as 'time'?",
		"options": ["dime", "dim", "dip", "did"],
		"correct_index": 0,
		"feedback_correct": "'Dime' uses the same silent-e pattern as 'time' — the 'i' says its name!",
		"feedback_wrong": "'Time' has a silent 'e' at the end. 'Dime' also has a silent 'e': 'dim' becomes 'dime'.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound.",
		"question": "Which word has the same vowel sound as 'top'?",
		"options": ["mop", "mope", "map", "mutt"],
		"correct_index": 0,
		"feedback_correct": "'Mop' has the same vowel sound as 'top' — a quick 'o' in the middle.",
		"feedback_wrong": "'Top' and 'mop' have the same quick 'o' sound in the middle.",
	},
...
const _TOWN_HALL_PRACTICE_L4 := [
	{
		...
		"question": "Which word uses 'ea' to make the SAME sound as in 'breathe'?",
		"options": ["dream", "bread", "sweat", "threat"],
		"correct_index": 0,
		"hint": "Say 'breathe' slowly. Which word uses 'ea' the same way?",
		"feedback_correct": "'Dream' uses 'ea' for the same long e sound as 'breathe'.",
		"feedback_wrong":
		"In 'breathe', the 'ea' makes a long e sound. 'Dream' uses 'ea' the same way. 'Bread', 'sweat', and 'threat' all use 'ea' for a short e sound instead.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound in this word.",
		"question": "Which word uses 'ea' to make the SAME sound as in 'threat'?",
		"options": ["sweat", "bean", "speak", "feast"],
		"correct_index": 0,
		"hint": "Say 'threat'. The 'ea' here makes a short sound. Find the word where 'ea' sounds the same.",
		"feedback_correct": "'Sweat' uses 'ea' the same way as 'threat' — both have a short e sound.",
		"feedback_wrong": "In 'threat', the 'ea' makes a short e sound. 'Sweat' also uses 'ea' for a short e.",
	},
	{
		"type": "tap_target",
...
const _TOWN_HALL_MISSION_L4 := [
	# Part 1 — Vowel MCQ (4 items)
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound in this word.",
		"question": "The 'ea' in 'breathe' sounds like the vowel in which word?",
		"options": ["see", "red", "say", "sue"],
		"correct_index": 0,
		"feedback_correct": "Correct! 'Breathe' has the same long e sound as 'see'.",
		"feedback_wrong": "The 'ea' in 'breathe' makes a long e sound, just like the vowel in 'see'.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound in this word.",
		"question": "The 'ea' in 'threat' sounds like the vowel in which word?",
		"options": ["bed", "bead", "bode", "mode"],
		"correct_index": 0,
		"feedback_correct": "Correct! 'Threat' has the same short e sound as 'bed'.",
		"feedback_wrong": "Despite the 'ea' spelling, 'threat' uses a short e sound, just like 'bed'.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound in this word.",
		"question": "'Through' rhymes with which word?",
		"options": ["blew", "throw", "thaw", "though"],
		"correct_index": 0,
		"feedback_correct": "Correct! 'Through' rhymes with 'blew' — both have the same long oo sound.",
		"feedback_wrong": "'Through' has a long oo vowel sound, like 'moon'. It rhymes with 'blew'.",
	},
	{
		"type": "mcq",
		"instruction": "Identify the vowel sound in this word.",
		"question": "The ending of 'thorough' sounds like which word ending?",
		"options": ["above", "arrow", "through", "thorn"],
		"correct_index": 0,
		"feedback_correct": "Correct! The 'ough' in 'thorough' sounds like the 'ove' in 'above' — a weak, unstressed vowel.",
		"feedback_wrong": "'Thorough' ends with a weak, unstressed vowel sound. The word 'above' ends with the same sound.",
	},
	# Part 2 — Tap Target Clusters (3 items)
	{
		"type": "tap_target",
...
static func _lookup_stages(building_id: String, level: int = 1) -> Dictionary:
	# Level-specific question lookup. 4 levels: 1 (Non Reader), 2 (Emerging), 3 (Developing), 4 (Fluent).
