...
func setup(id: String, label: String, color: Color,
		   unlocked: bool, sx: float, sy: float) -> void:
	building_id    = id
	...
	match id:
		"town_hall": _bw = 240.0; _bh = 340.0
		"school":    _bw = 180.0; _bh = 260.0
		"library":   _bw = 160.0; _bh = 290.0
		"market":    _bw = 220.0; _bh = 210.0
		"bakery":    _bw = 170.0; _bh = 200.0
		"well":      _bw = 130.0; _bh = 170.0
		_:           _bw = 180.0; _bh = 240.0
...
func _process(_delta: float) -> void:
	if _padlock != null and _padlock.visible:
